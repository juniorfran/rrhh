            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="employee">
                    ...
                    <label style="font-weight: normal;" class="margin-bottom-20 rem">
                        <input type="checkbox" name="remember"> Mantener activo
                    </label>
                    ...
                    <div class="forget-password">
                        ...
                        <p>
                            No te preocupes, click <a style="color:#F44336" href="javascript:;" id="forget-password">
                                aqui </a>
                ...
                <!-- BEGIN FORGOT PASSWORD FORM -->
                    ...
                    <p>
                        Ingresa su correo para reestablecer tu contraseña.
                    </p>
                ...
                <div class="tab-pane fade" id="manager">
                    ...
                    <label style="font-weight: normal;" class="margin-bottom-20">
                        <input type="checkbox" name="remember"> Mantenerme activo
                    </label>
